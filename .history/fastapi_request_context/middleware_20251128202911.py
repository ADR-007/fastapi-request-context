...
class RequestContextMiddleware:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        correlation_id = _get_header_value(
            scope, self.config.correlation_id_header
...
class FastAPIWrapperMiddleware:
    """Base class for ASGI middleware that wraps FastAPI applications.

    This provides a simpler interface for creating custom middleware
    while maintaining proper ASGI compatibility.
